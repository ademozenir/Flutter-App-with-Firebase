...
import 'package:veriekleme/src/features/core/models/dashboard/categories_model.dart';

class DashboardTopCourses extends StatelessWidget {
  const DashboardTopCourses({Key? key, required TextTheme txtTheme}) : super(key: key);
